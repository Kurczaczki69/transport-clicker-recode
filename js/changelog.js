...
alpha04.addEventListener("click", function() {changeVer(4)}, false);
alpha031.addEventListener("click", function() {changeVer(31)}, false);
alpha03.addEventListener("click", function() {changeVer(3)}, false);
alpha02.addEventListener("click", function() {changeVer(2)}, false);
alpha011.addEventListener("click", function() {changeVer(11)}, false);
alpha01.addEventListener("click", function() {changeVer(1)}, false);

// contents array

const contents = [
    "<h3> Wersja Alpha 0.4</h3> <br> - Zmieniono system kupna autobusów. Od teraz można kupować wiele autobusów na raz <br> - ",
