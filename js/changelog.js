...
const contents = [
  ...
  "<h3>Wersja ALPHA 0.5.0</h3> <h4>XX/10/2024</h4><br />- Dodano system logowania, tworzenia konta itp. <br />- Poprawki interfejsu, estetyki <br />- Wiele poprawek i optymalizacji kodu gry <br />- Gra zapisuje się teraz co 90 sekund zamiast co 3 sekundy, ponieważ dane są teraz przesyłane na serwery a nie zapisywane lokalnie(jedyne co przechowujemy to dane gry typu ilość pieniędzy itp. oraz twój email więc nie ma się o co martwić 😉) <br /> - Nowe menu listy zmian (tak, znowu) <br /> - Od teraz wpisanie zera w polu ilości autobusów przy kupnie autobusu nie nie zostanie zaakceptowane i nic się nie stanie <br /> - Wiele innych mniejszych zmian i poprawek",
];
