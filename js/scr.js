...
// JAK DODAĆ AUTOBUS
// 1. Dodaj do tabeli ovjektów "buses" z jego: kodem, nazwą, ceną, modyfikatorami, wymaganymi ulepszeniami
// 2. Dodaj go do tabeli busPrices
// 3. Stwórz listener na dole skryptu

const buses = [
    {code: "solu8", name: "Solaris Urbino 8", clickmod: 0, incomemod: 1, price: 500, requiredUpgr: "none"},
    {code: "solu9", name: "Solaris Urbino 9", clickmod: 0, incomemod: 2, price: 4000, requiredUpgr: "none"},
    {code: "solu105", name: "Solaris Urbino 10.5", clickmod: 1, incomemod: 0, price: 6000, requiredUpgr: "none"},
    {code: "solu12", name: "Solaris Urbino 12", clickmod: 2, incomemod: 0, price: 8000, requiredUpgr: "none"},
    {code: "sola86", name: "Solaris Alpino 8.6", clickmod: 2, incomemod: 2, price: 15000, requiredUpgr: "none"},
    {code: "solu18", name: "Solaris Urbino 18", clickmod: 0, incomemod: 4, price: 16000, requiredUpgr: "none"},
    {code: "solu24", name: "Solaris Urbino 24", clickmod: 4, incomemod: 0, price: 21000, requiredUpgr: "none"},
    {code: "manlion", name: "MAN Lion's City", clickmod: 6, incomemod: 0, price: 24000, requiredUpgr: "none"},
    {code: "solu12h", name: "Solaris Urbino 12 Hydrogen", clickmod: 7, incomemod: 0, price: 24500, requiredUpgr: "none"},
    {code: "jelczm121m", name: "Jelcz M121M", clickmod: 0, incomemod: 6, price: 25500, requiredUpgr: "none"},
    {code: "solu18h", name: "Solaris Urbino 18 Hydrogen", clickmod: 8, incomemod: 0, price: 27500, requiredUpgr: "none"},
    {code: "manlioncig", name: "MAN Lion's City GXL", clickmod: 8, incomemod: 4, price: 35000, requiredUpgr: "none"},
  ];  

const a20 = [
    {code: "mana20", name: "MAN A20", price: 0, incomemod: 0, clickmod: 1, requiredUpgr: "none"}
];
...
u8El.addEventListener("click", function() {buyBus("solu8");}, false);
u9El.addEventListener("click", function() {buyBus("solu9");}, false);
u105El.addEventListener("click", function() {buyBus("solu105");}, false);
u12El.addEventListener("click", function() {buyBus("solu12");}, false);
alp86El.addEventListener("click", function() {buyBus("sola86");}, false);
u18El.addEventListener("click", function() {buyBus("solu18");}, false);
u24El.addEventListener("click", function() {buyBus("solu24");}, false);
manlionEl.addEventListener("click", function() {buyBus("manlion");}, false);
u12hydEl.addEventListener("click", function() {buyBus("solu12h");}, false);
jelczm121mEl.addEventListener("click", function() {buyBus("jelczm121m");}, false);
u18hydEl.addEventListener("click", function() {buyBus("solu18h");}, false);
manlionlongEl.addEventListener("click", function() {buyBus("manlioncig");}, false);